...
public class IrFactory {
    ...
    private static int phiCounter = 0;
    ...
    public static Phi makePhi(IrTy irTy, BasicBlock host) {
        ArrayList<BasicBlock> blocks = new ArrayList<>(host.frontBbs);
        Phi phi = new Phi(host, phiCounter++, (DataIrTy) irTy, blocks);
        return phi;
    }
    
    public static Value makeMiddleValue(IrTy irTy) {
        Value value = new Value(null, "m" + middleCounter++, irTy);
        return value;
    }
}
